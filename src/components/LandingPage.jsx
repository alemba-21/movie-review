  ...
  return (
    <div className="main">
      ...
      <div className="content">
        ...
        <p>
          An ordinary miss felt lost and lonely. She visits an acient home town
          in Kinshasa for retrival.Based on true events.
        </p>
      </div>
      <div className="content1">
        ...
        <div className="feedback">{displayReview}</div>
      </div>
    </div>
  );
};
